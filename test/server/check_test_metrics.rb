...
def table_data
  ...
  [
    [ nil ],
    [ 'test.count',    stats['test_count'],    '>=',  19 ],
    ...
    [ nil ],
    [ 'test.lines.total',      test_cov['lines'   ]['total' ], '<=', 263 ],
    ...
    [ nil ],
    [ 'code.lines.total',      code_cov['lines'   ]['total' ], '<=', 409 ],
    [ 'code.lines.missed',     code_cov['lines'   ]['missed'], '<=', 89  ],
    [ 'code.branches.total',   code_cov['branches']['total' ], '<=', 54  ],
