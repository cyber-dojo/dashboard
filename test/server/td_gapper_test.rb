...
class TdGapperTest < TestBase
  ...
  | strip removes lightless tds from both ends
    ...
    unstripped =
      {
        hippo_id => { 0 => [], 1 => [t1], 2 => [], 3 => [], 4 => [t2], 5 => [], 6 => { collapsed: 4321 },
                      4327 => [] },
        lion_id => { 0 => [], 1 => [t3], 2 => [], 3 => [], 4 => [t4, t5], 5 => [], 6 => { collapsed: 4321 },
                     4327 => [] },
        panda_id => { 0 => [], 1 => [], 2 => [], 3 => [], 4 => [], 5 => [t6], 6 => { collapsed: 4321 },
                      4327 => [] }
      }
    stripped =
      {
  ...
  | time-ticks with collapsing and td-holes
    ...
    all_lights =
      {
        lion_id => [make_light(5, 0),
                    make_light(5, 10),
                    make_light(11, 0),
                    make_light(11, 10)],
        tiger_id => [make_light(5, 11),
                     make_light(7, 0),
                     make_light(7, 10),
                     make_light(18, 20)]
      }
