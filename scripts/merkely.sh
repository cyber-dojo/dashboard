...
merkely_log_artifact()
{
  local -r hostname="${1}"
    ...
    --env MERKELY_ARTIFACT_GIT_COMMIT=${CYBER_DOJO_DASHBOARD_SHA} \
    --env MERKELY_ARTIFACT_GIT_URL=https://github.com/${MERKELY_OWNER}/${MERKELY_PIPELINE}/commit/${CYBER_DOJO_DASHBOARD_SHA} \
